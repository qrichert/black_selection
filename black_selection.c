 ...
 * Made for fun, to test things.
 * Seems to work just fine but maybe not. Probably has memory leaks.
 * Also, [args] only supports a line length (number) as entry, not real black args.
 *
 * To compile, run:
